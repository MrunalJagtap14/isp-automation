...
<%
	ResultSet rs = con.createStatement().executeQuery("select * from plans order by plan_id");
%>

	  <div class="container">
	  
	  <h2>Plans List</h2>
	  <h3 align="right"><a href="add-plan.jsp" class="btn">Add Plan</a></h3>
...
%>
	<tr>
		...
		<td><a href="delete-plan.jsp?pid=<%=rs.getString(1)%>" class="btn">Delete</a></td>
		<td><a href="edit-plan.jsp?pid=<%=rs.getString(1)%>" class="btn">Edit</a></td>
	</tr>
<%
	}
%>	
