...
<form action="customer-register1.jsp" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" placeholder="Enter 10 digit mobile number" name="phone" required pattern="^[6789]\d{9}$">

    <label for="aadhar"><b>Aadhar Card Number</b></label>
    <input type="text" placeholder="Enter 12 digit Aadhar Card Number" name="aadhar" required pattern="^\d{12}$">
