      ...
      <div class="container">
        ...
        <form method="post" action="checkout.jsp">
          <div class="products">
            ...
            <div class="item">
              <span class="price">Rs.<%=rs.getString("cost")%></span>
              <p class="item-name"><%=rs.getString("plan_name")%></p>
              <p class="item-description"><%=rs.getString("speed")%>(<%=rs.getString("duration")%>)</p>
            </div>

            <div class="total">Total<span class="price">Rs.<%=rs.getString("cost")%></span></div>
          </div>
