            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="company-details">
                        <p class="text-white">Surfwell isp </p>
                        <p class="text-white">Pimpri Pune 411018</p>
                        <p class="text-white">+91 7709577438</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="sub-heading">Email Address: ispcustomer@gmail.com </p>
