...
<%
	ResultSet rs = con.createStatement().executeQuery("select * from complaints order by comp_id");
%>
...
%>
	<tr>
		...
		<td><a href="close-complaint.jsp?compid=<%=rs.getString(1)%>" class="btn">Close</a></td>
	</tr>
<%
	}
%>	
