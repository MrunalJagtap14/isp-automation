...
<%
	ResultSet rs = con.createStatement().executeQuery("select * from employee order by emp_id");
%>

	  <div class="container">
	  
	  <h2>Employee List</h2>
	  <h3 align="right"><a href="add-employee.jsp" class="btn">Add Employee</a></h3>
...
%>
	<tr>
		...
		<td><a href="delete-employee.jsp?eid=<%=rs.getString(1)%>" class="btn">Delete</a></td>
		<td><a href="edit-employee.jsp?eid=<%=rs.getString(1)%>" class="btn">Edit</a></td>
	</tr>
<%
	}
%>	
